function errorMessage(err){
    ...
    switch(err.code){
        ...
        case 'SIDNOTFOUND' : message = "session id does not exist";
        break;

        case 'SIDINSTM' : message = "cannot delete a session in progress";
        break;

        case 'JOIFALSE' : message = err.message;
        break;

        case 'JWTFALSE' : message = "session expired, please login again!!!";
        break;

        case 'TOKENFALSE' : message = "Login failed!!!";
        break;
